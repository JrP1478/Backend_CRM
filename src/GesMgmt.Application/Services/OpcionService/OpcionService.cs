            ...
            try
            {
                ...
                var data = (
                                    ...
                                    select new GetOpcionesResponseDto
                                    {
                                        ...
                                        sDescripcionOpcion = opt.sDescripcionOpcion ?? "",
                                        sUrlOpcion = opt.sUrlOpcion,
                                        sUrlBI = opt.sUrlBI ?? "",
                                        sIcono = opt.sIcono,
                                        sImagenOpcion = opt.sImagenOpcion ?? "",
                                        sEmailOpcion = opt.sEmailOpcion ?? "",
                                        nTipo = opt.nTipo,
            ...
            try
            {
                ...
                if (lq_options != null)
                {
                    data = new GetOpcionByIdResponseDto
                    {
                        ...
                        sDescripcionOpcion = lq_options.sDescripcionOpcion ?? "",
                        sUrlOpcion = lq_options.sUrlOpcion,
                        sUrlBI = lq_options.sUrlBI ?? "",
                        sIcono = lq_options.sIcono ?? "",
                        sImagenOpcion = lq_options.sImagenOpcion ?? "",
                        sEmailOpcion = lq_options.sEmailOpcion ?? "",
        ...
        public async Task<ResultDto<CreateOpcionResponseDto>> CreateOpcionAsync(CreateOpcionRequestDto opcionCreateDto)
        {
            ...
            try
            {
                Crm_Opcion Crm_Opcion = new Crm_Opcion
                {
                    ...
                    sDescripcionOpcion = opcionCreateDto.sDescripcionOpcion,
                    sUrlOpcion = opcionCreateDto.sUrlOpcion,
                    sUrlBI = opcionCreateDto.sUrlBI,
                    sIcono = opcionCreateDto.sIcono,
                    sImagenOpcion = opcionCreateDto.sImagenOpcion,
                    sEmailOpcion = opcionCreateDto.sEmailOpcion,
        ...
        public async Task<ResultDto<EditOpcionResponseDto>> EditOpcionAsync(EditOpcionRequestDto opcionEditDto)
        {
            ...
            try
            {
                ...
                Crm_Opcion Crm_Opcion = new Crm_Opcion
                {
                    ...
                    sDescripcionOpcion = opcionEditDto.sDescripcionOpcion,
                    sUrlOpcion = opcionEditDto.sUrlOpcion,
                    sUrlBI = opcionEditDto.sUrlBI,
                    sIcono = opcionEditDto.sIcono,
                    sImagenOpcion = opcionEditDto.sImagenOpcion,
                    sEmailOpcion = opcionEditDto.sEmailOpcion,
