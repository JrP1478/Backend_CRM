...
{
    public class EditReportarCasosRequestValidator
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IValidationMessageService _validationMessageService;
        private ValidationMessageDto _oValMsgDto;
        private EditReportarCasosRequestDto _requestDto;

        public EditReportarCasosRequestValidator(
            IUnitOfWork unitOfWork,
            IValidationMessageService validationMessageService,
            EditReportarCasosRequestDto requestDto)
        {
        ...
        public async Task<ResultDto<EditReportarCasosResponseDto>> Validate()
        {
            var validationNID_DOCXCOBRAROPERESULT = await Validate_nId_DocxCobrarOpeResult();
            if (validationNID_DOCXCOBRAROPERESULT.Code != Const.SUCCESS_CODE)
            {
                return validationNID_DOCXCOBRAROPERESULT;
            }
            ...
            return ResultDto<EditReportarCasosResponseDto>.Success(default, Const.SUCCESS_CODE, Const.SUCCESS_MESSAGE, Const.SUCCESS_MESSAGE, Const.OK_REQUEST_CODE);
        }

        private async Task<ResultDto<EditReportarCasosResponseDto>> Validate_nId_DocxCobrarOpeResult()
        {
            if (_requestDto.nId_DocxCobrarOpeResult == null)
            {
                _oValMsgDto = await _validationMessageService.GetByCode(ConstMsgVal.NID_DOCXCOBRAROPERESULT_REQUIRED, "ESP");
                return ResultDto<EditReportarCasosResponseDto>.Failure(_oValMsgDto.Code, _oValMsgDto.Message, _oValMsgDto.MessageFriendly, Const.BAD_REQUEST_CODE);
            }

            if (_requestDto.nId_DocxCobrarOpeResult <= 0)
            {
                _oValMsgDto = await _validationMessageService.GetByCode(ConstMsgVal.NID_DOCXCOBRAROPERESULT_REQUIRED, "ESP");
                return ResultDto<EditReportarCasosResponseDto>.Failure(_oValMsgDto.Code, _oValMsgDto.Message, _oValMsgDto.MessageFriendly, Const.BAD_REQUEST_CODE);
            }
        ...
        private async Task<ResultDto<EditReportarCasosResponseDto>> Validate_nId_Cliente()
        {
        ...
        private async Task<ResultDto<EditReportarCasosResponseDto>> Validate_nId_Cartera()
        {
        ...
        private async Task<ResultDto<EditReportarCasosResponseDto>> Validate_nId_DocXCobrar()
        {
        ...
        private async Task<ResultDto<EditReportarCasosResponseDto>> Validate_nId_UsuOpe()
        {
        ...
        private async Task<ResultDto<EditReportarCasosResponseDto>> Validate_ReportarCasos()
        {
        ...
        private async Task<ResultDto<EditReportarCasosResponseDto>> Validate_Descripcion()
        {
        ...
        private async Task<ResultDto<EditReportarCasosResponseDto>> Validate_Tipo_De_Siniestro()
        {
