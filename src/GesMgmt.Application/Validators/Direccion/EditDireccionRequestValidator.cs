...
{
    public class EditDireccionRequestValidator
    {
        private readonly IValidationMessageService _validationMessageService;
        private ValidationMessageDto _oValMsgDto;
        private EditDireccionRequestDto _requestDto;

        public EditDireccionRequestValidator(
            IUnitOfWork unitOfWork,
            IValidationMessageService validationMessageService,
            EditDireccionRequestDto requestDto)
        {
        ...
        public async Task<ResultDto<EditDireccionResponseDto>> Validate()
        {
            ...
            return ResultDto<EditDireccionResponseDto>.Success(default, Const.SUCCESS_CODE, Const.SUCCESS_MESSAGE, Const.SUCCESS_MESSAGE, Const.OK_REQUEST_CODE);
        }
        ...
        private async Task<ResultDto<EditDireccionResponseDto>> ValidateDireccion()
        {
            ...
            if (string.IsNullOrEmpty(_requestDto.cDirecc_Nomb))
            {
                ...
                return ResultDto<EditDireccionResponseDto>.Failure(_oValMsgDto.Code, _oValMsgDto.Message, _oValMsgDto.MessageFriendly, Const.BAD_REQUEST_CODE);
            }
