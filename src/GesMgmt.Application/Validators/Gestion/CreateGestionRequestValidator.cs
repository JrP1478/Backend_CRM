...
namespace GesMgmt.Application.Validators.Gestion
{
    public class CreateGestionRequestValidator
    {
        ...
        public async Task<ResultListDto<IEnumerable<CreateGestionOpeGesResponseDto>>> Validate()
        {
        ...
        private async Task<ResultListDto<IEnumerable<CreateGestionOpeGesResponseDto>>> ValidateDocumento()
        {
            ...
            if (_requestDto.nId_DocxCobrars.Length == 0)
            {
                _oValMsgDto = await _validationMessageService.GetByCode(ConstMsgVal.GESTION_SELECTED_ID, "ESP");
                return ResultListDto<IEnumerable<CreateGestionOpeGesResponseDto>>.Failure(_oValMsgDto.Code, _oValMsgDto.Message, _oValMsgDto.MessageFriendly, Const.BAD_REQUEST_CODE);
            }
        ...
        private async Task<ResultListDto<IEnumerable<CreateGestionOpeGesResponseDto>>> ValidateMontoCompromiso()
        {
        ...
        private async Task<ResultListDto<IEnumerable<CreateGestionOpeGesResponseDto>>> ValidateNroTelefono()
        {
        ...
        private async Task<ResultListDto<IEnumerable<CreateGestionOpeGesResponseDto>>> ValidateObservacion()
        {
            ...
            if (_requestDto.cOBSERVACION.Length > 2000)
            {
        ...
        private async Task<ResultListDto<IEnumerable<CreateGestionOpeGesResponseDto>>> ValidateEstadoGestion()
        {
