...
namespace GesMgmt.Application.Validators.Usuario
{
    public class CreateUsuarioRequestValidator
    {
        ...
        private async Task<ResultDto<CreateUsuarioResponseDto>> ValidateNroDoc()
        {
            ...
            var v_NroDoc = await _unitOfWork.Crm_Usuarios.GetByUsuarioByNroDocumentoAsync(_requestDto.cUsr_NroDoc);
            if (v_NroDoc != null)
            {
        ...
        private async Task<ResultDto<CreateUsuarioResponseDto>> ValidateAnexo()
        {
            ...
            var result = await _unitOfWork.Crm_Usuarios.GetByUsuarioByAnexoAsync(_requestDto.cUsr_Anexo.Trim());
            if (result != null)
            {
        ...
        private async Task<ResultDto<CreateUsuarioResponseDto>> ValidateLogin()
        {
            ...
            var result = await _unitOfWork.Crm_Usuarios.GetByUsuarioByLoginAsync(_requestDto.cUsr_Login.Trim());
            if (result != null)
            {
