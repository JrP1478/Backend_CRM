...
public sealed record RendimientoSupervisorCarteraRequest(
    string? Campana,
    long? IdSubCartera,
    int? IdSupervisor,
    DateOnly? FechaDesde,
    DateOnly? FechaHasta)
{
    ...
    public static bool IntentarCrear(
        ...
        string? fechaDesde,
        string? fechaHasta,
        out RendimientoSupervisorCarteraRequest? request,
        out Dictionary<string, string[]> errors)
    {
        ...
        request = new RendimientoSupervisorCarteraRequest(
            campanaNormalizada,
