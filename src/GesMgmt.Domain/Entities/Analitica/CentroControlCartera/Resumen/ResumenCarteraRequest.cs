...
public sealed record ResumenCarteraRequest(
    string? Campana,
    long? IdSubCartera,
    DateOnly? FechaDesde,
    DateOnly? FechaHasta)
{
    ...
    public static bool IntentarCrear(
        ...
        string? fechaDesde,
        string? fechaHasta,
        out ResumenCarteraRequest? request,
        out Dictionary<string, string[]> errors)
    {
        ...
        request = new ResumenCarteraRequest(
            campanaNormalizada,
    ...
    public bool IntentarResolverRango(
        ...
        out RangoResumenCartera range,
        out Dictionary<string, string[]> errors)
    {
        errors = [];

        var fechaDesde = FechaDesde ?? context.FechaInicio;
        var fechaHasta = FechaHasta ?? context.FechaUltimoDato ?? context.FechaFin;
        ...
        range = new RangoResumenCartera(fechaDesde, fechaHasta);
        return true;
    }
