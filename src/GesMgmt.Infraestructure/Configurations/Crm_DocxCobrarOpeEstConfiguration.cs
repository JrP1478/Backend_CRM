...
{
    public class Crm_DocxCobrarOpeEstConfiguration : IEntityTypeConfiguration<Crm_DocxCobrarOpeEst>
    {
        public void Configure(EntityTypeBuilder<Crm_DocxCobrarOpeEst> builder)
        {
            builder.ToTable("Crm_DocxCobrarOpeEst", "dbo");
            ...
            //builder.HasOne(dco => dco.Crm_OpeCodCliOutEst)
            //    .WithMany()
