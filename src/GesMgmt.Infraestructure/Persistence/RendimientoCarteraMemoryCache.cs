...
internal sealed class RendimientoCarteraMemoryCache :
    ICacheRendimientoCartera,
    IDisposable
{
    ...
    public RendimientoCarteraMemoryCache(
        RendimientoCentroControlCarteraOptions performance)
    {
        ...
        _cache = new MemoryCache(
            ...
            {
                SizeLimit = performance.MaximoEntradasCacheDetalle
            });
    }
