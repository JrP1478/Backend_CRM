...
namespace GesMgmt.UnitTests.Analitica.Identity;
...
public sealed class HttpAnaliticaUsuarioContextoTests
{
    ...
    public void TryGetUserId_ReadsSupportedClaimFromAuthenticatedIdentity(string claimType)
    {
        ...
        var result = context.IntentarObtenerIdUsuario(out var idUsuario);

        Assert.True(result);
        Assert.Equal(16068, idUsuario);
    }
    ...
    public void TryGetGroupId_ReadsSupportedClaimFromAuthenticatedIdentity(string claimType)
    {
        ...
        var result = context.IntentarObtenerIdGrupo(out var idGrupo);

        Assert.True(result);
        Assert.Equal(156, idGrupo);
    }
    ...
    public void TryGetGroupId_ReadsSisgesHeaderOutsideDevelopment()
    {
        ...
        Assert.True(context.IntentarObtenerIdGrupo(out var idGrupo));
        Assert.Equal(156, idGrupo);
    }
    ...
    public void TryGetUserId_IgnoresClaimsFromUnauthenticatedIdentity()
    {
        ...
        Assert.False(context.IntentarObtenerIdUsuario(out var idUsuario));
        Assert.Equal(0, idUsuario);
    }
    ...
    public void TryGetUserId_UsesConfiguredTestingUserOnlyInDevelopment()
    {
        ...
        Assert.True(context.IntentarObtenerIdUsuario(out var idUsuario));
        Assert.Equal(16068, idUsuario);
    }
    ...
    private static HttpContextoUsuarioAnalitica CreateContext(
        ...
        int? localTestingGroupId = null)
    {
        ...
        return new HttpContextoUsuarioAnalitica(
            accessor,
            configuration,
