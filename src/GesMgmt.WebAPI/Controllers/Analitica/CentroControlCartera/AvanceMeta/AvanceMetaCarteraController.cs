...
[Route("v1/Analitica/CentroControlCartera/AvanceMeta")]
...
public sealed class AvanceMetaCarteraController(IAvanceMetaCarteraService service) : AnaliticaControllerBase
{
    [HttpGet]
    [ProducesResponseType(typeof(AvanceMetaCarteraResponse), StatusCodes.Status200OK)]
