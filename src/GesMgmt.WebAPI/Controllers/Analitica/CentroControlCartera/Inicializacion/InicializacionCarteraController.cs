...
[Route("v1/Analitica/CentroControlCartera/Inicializacion")]
...
public sealed class InicializacionCarteraController(IInicializacionCarteraService service) : AnaliticaControllerBase
{
    [HttpGet]
    [ProducesResponseType(typeof(InicializacionCarteraResponse), StatusCodes.Status200OK)]
