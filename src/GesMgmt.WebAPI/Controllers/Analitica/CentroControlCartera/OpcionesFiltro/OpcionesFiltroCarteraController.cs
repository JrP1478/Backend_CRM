...
[Route("v1/Analitica/CentroControlCartera/OpcionesFiltro")]
...
public sealed class OpcionesFiltroCarteraController(IOpcionesFiltroCarteraService service) : AnaliticaControllerBase
{
    [HttpGet]
    [ProducesResponseType(typeof(OpcionesFiltroCarteraResponse), StatusCodes.Status200OK)]
