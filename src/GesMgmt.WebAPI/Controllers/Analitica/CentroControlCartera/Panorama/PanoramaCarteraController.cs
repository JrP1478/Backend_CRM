...
[Route("v1/Analitica/CentroControlCartera/Panorama")]
...
public sealed class PanoramaCarteraController(IPanoramaCarteraService service) : AnaliticaControllerBase
{
    [HttpGet]
    [ProducesResponseType(typeof(PanoramaCarteraResponse), StatusCodes.Status200OK)]
