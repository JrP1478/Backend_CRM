...
[Route("v1/Analitica/CentroControlCartera/Promesas")]
...
public sealed class PromesasCarteraController(IPromesasCarteraService service) : AnaliticaControllerBase
{
    [HttpGet]
    [ProducesResponseType(typeof(PromesasCarteraResponse), StatusCodes.Status200OK)]
