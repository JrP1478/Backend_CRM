...
[Route("v1/Analitica/CentroControlCartera/Promesas/Seguimiento")]
...
public sealed class SeguimientoPromesasCarteraController(ISeguimientoPromesasCarteraService service)
    : AnaliticaControllerBase
{
    [HttpGet]
    [ProducesResponseType(typeof(SeguimientoPromesasCarteraResponse), StatusCodes.Status200OK)]
