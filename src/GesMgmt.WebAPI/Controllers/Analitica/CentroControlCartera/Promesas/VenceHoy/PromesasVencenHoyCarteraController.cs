...
[Route("v1/Analitica/CentroControlCartera/Promesas/VenceHoy")]
...
public sealed class PromesasVencenHoyCarteraController(IPromesasVencenHoyCarteraService service) : AnaliticaControllerBase
{
    [HttpGet]
    [ProducesResponseType(typeof(PromesasVencenHoyCarteraResponse), StatusCodes.Status200OK)]
