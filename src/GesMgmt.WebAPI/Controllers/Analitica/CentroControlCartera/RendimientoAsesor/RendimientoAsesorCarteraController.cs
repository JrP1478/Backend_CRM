...
[Route("v1/Analitica/CentroControlCartera/RendimientoAsesor")]
...
public sealed class RendimientoAsesorCarteraController(IRendimientoAsesorCarteraService service) : AnaliticaControllerBase
{
    [HttpGet]
    [ProducesResponseType(typeof(RendimientoAsesorCarteraResponse), StatusCodes.Status200OK)]
