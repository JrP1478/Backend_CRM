...
[Route("v1/Analitica/CentroControlCartera/RendimientoCampana")]
...
public sealed class RendimientoCampanaCarteraController(IRendimientoCampanaCarteraService service) : AnaliticaControllerBase
{
    [HttpGet]
    [ProducesResponseType(typeof(RendimientoCampanaCarteraResponse), StatusCodes.Status200OK)]
