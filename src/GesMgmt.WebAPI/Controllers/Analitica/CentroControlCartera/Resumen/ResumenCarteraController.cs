...
[Route("v1/Analitica/CentroControlCartera/Resumen")]
...
public sealed class ResumenCarteraController(IResumenCarteraService service) : AnaliticaControllerBase
{
    [HttpGet]
    [ProducesResponseType(typeof(ResumenCarteraResponse), StatusCodes.Status200OK)]
